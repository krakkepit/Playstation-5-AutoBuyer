...
locations = {
    ...
    'Alternate DE Disk': {
        ...
        'outOfStockLabel': "Artikel kann derzeit nicht gekauft werden",
    ...
    'MEDIAMARKT Digital': {
        ...
        'outOfStockLabel': "offline-icon",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'MEDIAMARKT Disk + accessoires + spider man + ratchet': {
        'webshop': 'mediamarkt',
        'url': 'https://www.mediamarkt.nl/nl/product/_sony-playstation-5-disk-edition-accessoirespakket-spider-man-miles-morales-ratchet-clank-rift-apart-1700381.html',
        'inStock': False,
        'inStockLabel': "Bestel nu",
        'outOfStockLabel': "offline-icon",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'MEDIAMARKT Disk + controller wit + laadkabel, station + headset + duimgr + ratchet': {
        'webshop': 'mediamarkt',
        'url': 'https://www.mediamarkt.nl/nl/product/_sony-ps5-disk-edition-dualsense-wit-laadkabel-laadstation-headset-duim-grips-ratchet-clank-ra-1701594.html',
        'inStock': False,
        'inStockLabel': "Bestel nu",
        'outOfStockLabel': "offline-icon",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'MEDIAMARKT Disk + controller zwart + laadkabel, station + headset + duimgr + ratchet': {
        'webshop': 'mediamarkt',
        'url': 'https://www.mediamarkt.nl/nl/product/_sony-ps5-disk-edition-dualsense-zwart-laadkabel-laadstation-headset-duim-grips-ratchet-clank-ra-1701596.html',
        'inStock': False,
        'inStockLabel': "Bestel nu",
        'outOfStockLabel': "offline-icon",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'MEDIAMARKT Disk + controller rood + laadkabel, station + headset + duimgr + ratchet': {
        'webshop': 'mediamarkt',
        'url': 'https://www.mediamarkt.nl/nl/product/_sony-ps5-disk-edition-dualsense-rood-laadkabel-laadstation-headset-duim-grips-ratchet-clank-ra-1701595.html',
        'inStock': False,
        'inStockLabel': "Bestel nu",
        'outOfStockLabel': "offline-icon",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'MEDIAMARKT Disk + laadkabel + laadstation + headset + duim gr + ratchet + spider man': {
        'webshop': 'mediamarkt',
        'url': 'https://www.mediamarkt.nl/nl/product/_sony-ps5-disk-edition-laadkabel-laadstation-headset-duim-grips-ratchet-clank-ra-spider-man-mm-1701597.html',
        'inStock': False,
        'inStockLabel': "Bestel nu",
        'outOfStockLabel': "offline-icon",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'MEDIAMARKT Disk + controller zwart + accessoires + ghost of tsu': {
        'webshop': 'mediamarkt',
        'url': 'https://www.mediamarkt.nl/nl/product/_sony-playstation-5-disk-edition-dualsense-zwart-accessoirespakket-ghost-of-tsushuma-director-s-cut-1703696.html',
        'inStock': False,
        'inStockLabel': "Bestel nu",
        'outOfStockLabel': "offline-icon",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
